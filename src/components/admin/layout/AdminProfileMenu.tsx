        ...
        {isMenuOpen && (
          ...
          >
            <div className="px-3 py-3 text-sm text-slate-500 font-medium border-b border-slate-100 mb-2 dark:border-slate-700 dark:text-slate-400">
              ...
              <p className="text-slate-800 font-bold text-base truncate dark:text-slate-100">Farhan M.</p>
              <p className="text-[11px] mt-0.5 text-blue-600 dark:text-blue-400 font-semibold">President</p>
            </div>
            <button 
              onClick={() => {
                setIsMenuOpen(false);
